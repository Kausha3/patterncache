...
export const GLOSSARY: Record<string, { term: string; plain: string }> = {
  client: { term: "Client", plain: "The thing making requests — a web browser or phone app. It asks; the server answers." },
  ...
  database: { term: "Database", plain: "Durable storage that remembers data between requests — accounts, posts, orders — even if a server restarts." },
  ...
  fanout: { term: "Fan-out", plain: "Delivering one item to many recipients — e.g. writing a new post into thousands of followers' feeds." },

  ...
  design: {
    ...
    methods: [
      ...
      },
      {
        ...
        ownerId: "lot",
        justification: "Whether the whole garage is full is a property of the aggregate, not any single Level — it has to ask each Level's free count and combine them, which only ParkingLot is positioned to do.",
      },
      {
        id: "m3",
        signature: "findSpotOnLevel(vehicle): Spot",
        ownerId: "level",
        justification: "Level owns its own list of spots, so searching within one floor is Level's job — ParkingLot shouldn't reach past Level to scan raw ParkingSpots itself, that would break encapsulation of Level's internal list.",
      },
      {
        id: "m4",
      ...
      },
      {
        ...
        ownerId: "vehicle",
        justification: "Size is data Vehicle itself holds — it's a plain accessor, not a decision, so it belongs on the object whose field it's reading, not on whatever class happens to need the value.",
      },
      {
        id: "m8",

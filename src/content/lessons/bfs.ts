...
export const bfs: DSALesson = {
  ...
  blurb: "Explore in rings — the first time you reach the goal is the shortest way.",
  estMinutes: 5,
  concept: {
    bruteForce:
    ...
    insight:
      "Explore in rings of equal distance. A FIFO queue always hands back the nearest unexplored cell next, so cells come out in strict distance order. The first time you dequeue the target, you've reached it in the fewest possible steps — no route is ever explored out of order.",
    complexity: "O(V + E)",
    recognize:
  ...
  recap: [
    "BFS explores in order of distance, so the first time it touches the target, that's the shortest path — by construction, not by checking.",

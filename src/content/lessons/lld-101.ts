...
export const lld101: LLDLesson = {
  ...
  overview:
    ...
    "This lesson uses the smallest possible example, a single alarm clock, so you can watch that reasoning happen once, cleanly, before Parking Lot asks you to do it across six classes at once. No clarifying-questions phase here on purpose, since that's a real interview skill worth its own lesson later. This one is just about the four words above.",
  design: {
    entities: [
      {
        id: "clock",
    ...
    edgeCases: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: "c", label: "snooze() throws an error and crashes the app.", correct: false, feedback: "Crashing over a harmless button press is worse than doing nothing. Save hard failures for situations that actually corrupt data." },
        ],
      },
    ],
    tradeoffs: [

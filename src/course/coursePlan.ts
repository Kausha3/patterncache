...
const SPRINT_15: CourseDay[] = [
  {
    ...
    tasks: [
      task("d1-coding", "45-minute coding diagnostic", 45, "Solve one medium problem without hints. Record pattern, misses, complexity, and tests.", "coding"),
      task("d1-design", "45-minute design diagnostic", 45, "Choose Parking Lot for L4 or URL Shortener for L5/L6. Work from a blank page.", "design"),
  ...
  },
  {
    ...
    tasks: [
      ...
      task("d2-cold", "Four cold array problems", 55, "Two pointer problems and two window problems. Explain the trigger before coding.", "coding"),
  ...
  },
  {
    ...
    tasks: [
      ...
      task("d3-dfs", "DFS and tree traversal set", 50, "Solve one tree DFS, one grid DFS, and one topological-order problem.", "coding"),
  ...
  },
  {
    ...
    tasks: [
      task("d4-heap", "Heap / Top-K pair", 35, "Solve one selection problem and one streaming Top-K problem.", "coding"),
      task("d4-intervals", "Intervals and scheduling", 30, "Solve one merge and one meeting-room style problem.", "coding"),
      task("d4-binary", "Binary-search boundary drill", 25, "Practice first-true/last-false boundary reasoning.", "coding"),
  ...
  },
  {
    ...
    tasks: [
      task("d5-backtracking", "Backtracking pair", 40, "State the choice, constraint, and undo step before coding.", "coding"),
      task("d5-dp", "Core DP pair", 45, "Define state, transition, base case, and iteration order before implementation.", "coding"),
  ...
  },
  {
    ...
    tasks: [
      ...
      task("d9-failure", "Failure injection", 30, "Revisit both systems after a gateway failure and one celebrity-scale hot key.", "design"),
  ...
  },
  {
    ...
    tasks: [
      ...
      task("d11-redraw", "Parking Lot from memory", 25, "Redraw the classes and relationships without reopening the lesson.", "design"),
  ...
  },
  {
    ...
    tasks: [
      ...
      task("d12-code", "Code two core methods", 30, "Write one allocation method and one state-transition method with tests.", "coding"),
...
const SPRINT_30: CourseDay[] = [
  ...SPRINT_15.slice(0, 1),
  { day: 2, title: "Two Pointers", focus: "Pointer invariants", tasks: [lesson("two-pointer", "Two Pointers", 15, "Drive the pattern on a new input."), task("30-d2", "Two cold problems", 45, "State the invariant before coding.", "coding"), starStory("30-d2", "Customer Obsession")] },
  { day: 3, title: "Sliding Window", focus: "Expand and shrink correctly", tasks: [lesson("sliding-window", "Sliding Window", 15, "Connect the constraint to the shrink condition."), task("30-d3", "Three cold windows", 50, "Mix fixed and variable windows.", "coding"), starStory("30-d3", "Ownership")] },
  { day: 4, title: "Hashing and prefix sums", focus: "Turn history into constant-time lookup", tasks: [task("30-d4a", "Hash-map pair", 35, "Frequency and seen-state problems.", "coding"), task("30-d4b", "Prefix-sum pair", 35, "Subarray count and range reasoning.", "coding"), task("30-d4r", "Recognition notes", 10, "Write the trigger for each pattern.", "review")] },
  { day: 5, title: "Stack, queue, linked list", focus: "Stateful traversal", tasks: [task("30-d5a", "Stack / queue pair", 35, "Include one monotonic-stack problem.", "coding"), task("30-d5b", "Linked-list pair", 35, "Pointer safety and cycle reasoning.", "coding"), starStory("30-d5", "Bias for Action")] },
  { day: 6, title: "BFS", focus: "Shortest unweighted paths", tasks: [lesson("bfs", "BFS / Shortest Path", 18, "Trace the queue and visited set."), task("30-d6", "Two BFS problems", 45, "One tree and one grid.", "coding"), starStory("30-d6", "Dive Deep")] },
  { day: 7, title: "DFS and recursion", focus: "Recursive state and unwind", tasks: [task("30-d7", "Three DFS problems", 65, "Tree, grid, and path construction.", "coding"), task("30-d7r", "BFS vs DFS", 10, "Write the selection rule.", "review")] },
  { day: 8, title: "Graphs", focus: "Dependencies and connectivity", tasks: [task("30-d8a", "Topological sort", 30, "Model indegree and cycle failure.", "coding"), task("30-d8b", "Union-find", 30, "Connectivity with path compression.", "coding"), starStory("30-d8", "Learn and Be Curious")] },
  { day: 9, title: "Heap and intervals", focus: "Ordering and scheduling", tasks: [task("30-d9a", "Heap / Top-K pair", 35, "Selection and streaming.", "coding"), task("30-d9b", "Interval pair", 35, "Merge and meeting rooms.", "coding")] },
  ...
  { day: 11, title: "Binary search", focus: "Boundary correctness", tasks: [task("30-d11", "Three boundary problems", 65, "Practice first true, last false, and search on answer.", "coding"), starStory("30-d11", "Are Right, A Lot")] },
  { day: 12, title: "Backtracking", focus: "Choice, constraint, undo", tasks: [task("30-d12", "Three backtracking problems", 70, "Subsets, combinations, and constrained search.", "coding")] },
  { day: 13, title: "Dynamic programming I", focus: "State and transition", tasks: [task("30-d13", "One-dimensional DP", 70, "Define state before recurrence.", "coding"), task("30-d13r", "State notebook", 10, "Record state, base case, transition, order.", "review")] },
  { day: 14, title: "Dynamic programming II", focus: "Grid and sequence DP", tasks: [task("30-d14", "Two DP problems", 75, "One grid and one sequence problem.", "coding"), starStory("30-d14", "Think Big")] },
  ...
  { day: 22, title: "Amazon Locker", focus: "Allocation and lifecycle", tasks: [lesson("amazon-locker", "Amazon Locker", 35, "Model package and locker state."), task("30-d22", "Locker from memory", 30, "Redraw and code one allocation method.", "design")] },
  ...
  { day: 24, title: "Vending Machine", focus: "State-machine design", tasks: [lesson("vending-machine", "Vending Machine", 35, "Model payment and dispensing states."), task("30-d24", "State transition tests", 25, "Write tests for refund and out-of-stock paths.", "coding")] },

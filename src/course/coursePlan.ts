...
const SPRINT_15: CourseDay[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      task("d13-patterns", "Spot the Pattern + SOLID", 20, "Complete the pattern scenarios, then skim the SOLID receipts below the pattern list.", "review", "/patterns"),
...
const SPRINT_30: CourseDay[] = [
  ...
  { day: 25, title: "Coupon and Chess", focus: "Extensibility and rules", tasks: [lesson("discount-coupon-system", "Discount / Coupon", 35, "Eligibility and strategy variation."), lesson("chess-game", "Chess Game", 35, "Rules and game state."), task("30-d25p", "Patterns and SOLID review", 25, "Review the patterns and the SOLID receipts through their real examples.", "review", "/patterns"), starStory("30-d25", "Dive Deep")] },

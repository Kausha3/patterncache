...
const OCP_MISSION: SolidChapterMission = {
  ...
  repairBench: {
    ...
    controls: TARIFFS.map((tariff) => ({
      ...
      options: [
        { id: "branch", label: "Wedge it into calculateFee(), ships in ten minutes" },
        { id: "card", label: "A separate policy file, means wiring the TariffPolicy contract first" },
      ],
      initial: "branch",
    })),
    rows: [
    ...
    controls: [
      {
        ...
        options: [
          { id: "branch", label: "One more if inside decideLane(), quickest to land" },
          { id: "policy", label: "A LanePolicy file of its own, more plumbing tonight" },
        ],
        initial: "branch",
      },
      {
...
const ISP_MISSION: SolidChapterMission = {
  ...
  repairBench: {
    ...
    controls: DEVICE_OPS.map((op) => ({
      ...
      options: [
        { id: "universal", label: "Keep the one GarageDevice contract every device already implements" },
        { id: "role", label: `A new ${op.device}-only contract, one more interface to maintain` },
      ],
      initial: "universal",
    })),
    rows: [
    ...
    controls: [
      {
        ...
        options: [
          { id: "god", label: "The one GarageApi everything already imports" },
          { id: "client", label: "A new EntryApi, and the gate app has to migrate to it" },
        ],
        initial: "god",
      },
      {
        ...
        options: [
          { id: "god", label: "The one GarageApi everything already imports" },
          { id: "client", label: "A new BillingApi, and payments has to migrate to it" },
        ],
        initial: "god",
      },
      {
        ...
        options: [
          { id: "god", label: "The one GarageApi everything already imports" },
          { id: "client", label: "A new ReportsApi, and the dashboard has to migrate to it" },
        ],
        initial: "god",
      },
    ],
    ...
    controls: [
      {
        ...
        options: [
          { id: "construct", label: "new AcmePayClient() right where the exit flow needs it, zero ceremony" },
          { id: "port", label: "A PaymentPort handed in from outside, wiring to set up first" },
        ],
        initial: "construct",
      },
      {

...
const AMAZON: CompanyInterviewProfile = {
  ...
  dimensions: [
    ...
    },
    {
      ...
      plain: "You use judgment, seek contrary evidence, and update the decision when facts change.",
      signals: [
        ["assumption", "hypothesis", "judgment", "expected", "believed"],
        ["contrary", "disconfirm", "asked for feedback", "second opinion", "new evidence", "changed my mind"],
        ["decision", "chose", "trade-off", "because", "measured"],
      ],
      antiSignals: ["i just knew", "there was no other option", "i ignored the feedback"],
      probes: ["Which fact would have changed your decision?", "Whose view did you seek because it challenged yours?"],
    },
    {
      id: "highest-standards",
      name: "Insist on the Highest Standards",
      plain: "You prevent defects from moving downstream and leave a mechanism that keeps quality high.",
      signals: [
        ["quality", "defect", "regression", "test", "review", "reliability", "security"],
        ["bar", "standard", "checklist", "automation", "monitor", "gate"],
        ["prevented", "reduced", "caught", "stayed", "recurrence"],
      ],
      antiSignals: ["good enough", "we would fix it later", "nobody noticed"],
      probes: ["What mechanism kept the bar high after you left?", "When did quality conflict with the deadline?"],
    },
    {
      id: "think-big",
      name: "Think Big",
      plain: "You turn a narrow request into a credible direction with meaningfully larger customer value.",
      signals: [
        ["broader", "platform", "reusable", "many teams", "more customers", "scaled"],
        ["vision", "opportunity", "long term", "future", "roadmap"],
        ["prototype", "milestone", "adoption", "evidence", "validated"],
      ],
      antiSignals: ["boil the ocean", "big idea with no plan", "someone else could execute it"],
      probes: ["What made the larger direction credible?", "What was the first small proof?"],
    },
    {
      id: "bias-for-action",
      name: "Bias for Action",
      plain: "You move quickly on a reversible decision while naming the risk and safety check.",
      signals: [
        ["moved quickly", "acted", "decided", "same day", "deadline", "urgent"],
        ["reversible", "rollback", "feature flag", "guardrail", "limited blast radius"],
        ["risk", "trade-off", "monitor", "checkpoint", "corrected"],
      ],
      antiSignals: ["waited for perfect information", "rushed without checking", "hoped it worked"],
      probes: ["Why was it safe to act before knowing everything?", "What was the rollback plan?"],
    },
    {
      id: "frugality",
      name: "Frugality",
      plain: "You use constraints to simplify without hiding a quality, security, or reliability cost.",
      signals: [
        ["constraint", "budget", "limited", "small team", "time"],
        ["reused", "removed", "simpler", "automated", "lower cost"],
        ["saved", "cost", "hours", "capacity", "without sacrificing"],
      ],
      antiSignals: ["cut testing", "accepted the outage", "made someone else absorb the cost"],
      probes: ["What quality cost did you refuse to trade away?", "When would the cheaper approach stop being enough?"],
    },
    {
      id: "hire-develop-best",
      name: "Hire and Develop the Best",
      plain: "You raise another person's capability through specific feedback, mentoring, or opportunity.",
      signals: [
        ["mentored", "coached", "feedback", "onboarded", "taught", "paired"],
        ["opportunity", "ownership", "delegated", "growth", "confidence"],
        ["independent", "promoted", "faster", "quality", "afterward"],
      ],
      antiSignals: ["did it for them", "kept the important work", "they were not capable"],
      probes: ["What became possible for that person without you?", "Which feedback was hard to give?"],
    },
    {
      id: "best-employer",
      name: "Strive to be Earth's Best Employer",
      plain: "You improve safety, inclusion, growth, or effectiveness for the people around you.",
      signals: [
        ["included", "accessible", "safe", "burnout", "on-call", "belonging"],
        ["listened", "asked", "feedback", "barrier", "support"],
        ["improved", "reduced", "participation", "retention", "confidence"],
      ],
      antiSignals: ["they should adapt", "not a work problem", "everyone was treated identically"],
      probes: ["Whose experience improved and how do you know?", "What did you learn from the people affected?"],
    },
    {
      id: "success-scale",
      name: "Success and Scale Bring Broad Responsibility",
      plain: "You consider second-order effects and leave customers, communities, or systems better as impact grows.",
      signals: [
        ["second-order", "downstream", "privacy", "security", "accessibility", "environment"],
        ["scale", "more users", "wider impact", "risk", "unintended"],
        ["guardrail", "audit", "monitor", "review", "mitigation"],
      ],
      antiSignals: ["growth at any cost", "not our problem", "we could fix consequences later"],
      probes: ["Who could be harmed if this succeeded at scale?", "Which guardrail did you add before expanding?"],
    },
  ],
  loop: [
    {
      ...
      purpose: "Customer impact, personal ownership, and a finished result.",
      dimensionIds: ["customer-obsession", "ownership", "deliver-results"],
      questionCount: 3,
    },
    {
      id: "round-2",
      ...
      purpose: "Resume claims, technical depth, simplification, and quality mechanisms.",
      dimensionIds: ["dive-deep", "invent-simplify", "highest-standards"],
      questionCount: 3,
    },
    {
      id: "round-3",
      ...
      purpose: "Judgment, action under ambiguity, trust, and respectful disagreement.",
      dimensionIds: ["are-right-a-lot", "bias-for-action", "earn-trust", "disagree-commit"],
      questionCount: 3,
    },
    {
      id: "round-4",
      kind: "behavioral",
      title: "Interview round 4",
      purpose: "Learning, scale, people development, frugality, and responsible impact.",
      dimensionIds: ["learn-curious", "think-big", "frugality", "hire-develop-best", "best-employer", "success-scale"],
      questionCount: 3,
    },
  ],
  archetypes: [
    ...
    { id: "judgment", kind: "behavioral", dimensionIds: ["are-right-a-lot"], template: "Tell me about a decision where new evidence proved one of your assumptions wrong.", followUps: ["Whose contrary view did you seek?", "Which fact changed the decision?"] },
    { id: "act-ambiguity", kind: "behavioral", dimensionIds: ["bias-for-action"], template: "Tell me about a time you acted before all the information was available. How did you contain the risk?", followUps: ["What made the decision reversible?"] },
    { id: "quality-mechanism", kind: "behavioral", dimensionIds: ["highest-standards"], template: "Tell me about a time you refused to let a quality problem move downstream and created a lasting mechanism.", followUps: ["What did the mechanism catch later?"] },
    { id: "bigger-direction", kind: "behavioral", dimensionIds: ["think-big"], template: "Tell me about a time you turned a narrow request into a larger, credible opportunity.", followUps: ["What was the first proof that it was more than an idea?"] },
    { id: "constraint", kind: "behavioral", dimensionIds: ["frugality"], template: "Tell me about a time a hard constraint led you to a simpler solution without lowering the quality bar.", followUps: ["When would that solution stop being enough?"] },
    { id: "develop-person", kind: "behavioral", dimensionIds: ["hire-develop-best", "best-employer"], template: "Tell me about a time you helped another person become more effective or take on larger ownership.", followUps: ["What could they do independently afterward?"] },
    { id: "responsible-scale", kind: "behavioral", dimensionIds: ["success-scale"], template: "Tell me about a time you considered an unintended consequence before expanding a successful change.", followUps: ["Who could have been harmed without the guardrail?"] },
